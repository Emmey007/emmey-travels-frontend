...
export const BoatCruise = () => {
  ...
  useEffect(() => {
    const fetch = async () => {
      try {
        ...
        setError("Could not load boat cruises");
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div style={styles.page}>
      <div style={{ ...styles.hero, background: "#0a2240" }}>
        <h1 style={styles.heroTitle}>⛵ Boat Cruises</h1>
        <p style={styles.heroSub}>
          Scenic boat cruises across rivers, lakes and coastlines
        </p>
        <input
          style={styles.search}
      ...
      <div style={styles.container}>
        {loading && <p style={styles.loading}>Loading boat cruises...</p>}
        {error && <p style={styles.error}>{error}</p>}

        {!loading && filtered.length === 0 && (
          <div style={styles.empty}>
            <p style={styles.emptyIcon}>⛵</p>
            <p style={styles.emptyTitle}>No boat cruises available</p>
            <p style={styles.emptyText}>
              Check back soon or contact us for custom boat packages.
            </p>
          </div>
        )}
